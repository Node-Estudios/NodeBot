    ...
    constructor(client) {
        super(client, {
            ...
            description_localizations: {
                'es-ES': 'Recibir una notificación cuando un streamer prende o apaga directo.',
            },
            cooldown: 5,
            options: [
                {
                    ...
                    options: [
                        {
                            ...
                            options: [
                                ...
                                },
                                {
                                    type: 3,
                                    name: 'description',
                                    description: 'Description of  the embed that the bot will send',
                                    required: true,
                                },
                                {
                                    type: 3,
                                ...
                                },
                                {
                                    type: 3,
                                    name: 'footericon',
                                    description: 'Want the embed to have any footer image? Paste the url',
                                    required: false,
                                },
                                {
                                    type: 3,
                ...
                },
                {
                    type: 2,
                    name: 'private',
                    description: 'Node bot will send you a private message when your favourite streamer goes Live!',
                    options: [
                        {
                            type: 1,
                            name: 'create',
                        ...
                        axios
                            ...
                            .then(async res => {
                                ...
                                TwitchModel.findOne({
                                                                    ...
                                                                    customMessage: {
                                                                        embed: {
                                                                            ...
                                                                            description: interaction.options
                                                                                ...
                                                                                .toString(),
                                                                            footer: interaction.options.getString(
                                                                                'footer',
                                                                            ),
                                                                            footericon:
                                    ...
                                    */
                                        if (
                                            s.Interacciones.Guilds.findIndex(i => i.id === interaction.guild.id) == -1
                                        ) {
                        ...
                        axios
                            ...
                            .then(async res => {
                                ...
                                TwitchModel.findOne({
                                    ...
                                    */
                                        if (
                                            s.Interacciones.Users.findIndex(i => i.id == interaction.member.id) === -1
                                        ) {
                            ...
                            .then(async res => {
                                ...
                                TwitchModel.findOne({
                                    ...
                                    if (s) {
                                        if (res.data.data[0]) {
                                            if (
                                                s.Interacciones.Users.findIndex(i => i.id === interaction.member.id) !=
                                                -1
                                            ) {
