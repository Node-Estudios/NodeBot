                ...
                switch (option) {
                    case '963496530818506802':
                        errorembed.setDescription(
                            'Node2 <:logonodemorado:968094477480771584> no se encuentra en el servidor, invítalo haciendo [Click Aquí](https://discord.com/api/oauth2/authorize?client_id=963496530818506802&permissions=137475976512&scope=bot)',
                        )
                        break
                    case '963954741837201540':
                        errorembed.setDescription(
                            'Node3 <:logonodenaranja:968094477019402292> no se encuentra en el servidor, invítalo haciendo [Click Aquí](https://discord.com/api/oauth2/authorize?client_id=963954741837201540&permissions=137475976512&scope=bot)',
                        )
                        break
                    case '853888393917497384':
                        errorembed.setDescription(
                            'Node4 <:logonodeazul:968094477866659850> no se encuentra en el servidor, invítalo haciendo [Click Aquí](https://discord.com/api/oauth2/authorize?client_id=853888393917497384&permissions=137475976512&scope=bot)',
                        )
                        break
                }
