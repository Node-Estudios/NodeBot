                            ...
                            client.shard.broadcastEval(
                                (c, context) => {
                                    if (c.guilds.cache.get(context.guild.id)) {
                                        ...
                                        if (
                                            context.guild.customMessage.embed &&
                                            !context.guild.customMessage.embed.length
                                        ) {
                                            ...
                                            guild2.channels.cache
                                                .get(context.guild.textChannel.replace('<#', '').replace('>', ''))
                                                .send({ embeds: [embed] });
                                        }
                                        if (
                                            context.guild.customMessage.link &&
                                            !context.guild.customMessage.link.length
                                        ) {
                                        }
                                    }
                                },
