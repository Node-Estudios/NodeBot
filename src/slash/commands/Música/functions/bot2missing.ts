import bot3missing from './bot3missing.js';
export default async function bot2missing(client, interaction, data, reqEndpoint) {
    ...
    await interaction.guild.members
        ...
        .then(member => {
            ...
            if (member.voice.channel && member.voice.channel == interaction.member.voice.channel) addToQueue3 = true;
        })
        .catch(e => {
            bot3Availability = false;
        });
