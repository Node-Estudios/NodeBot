import bot4missing from './bot4missing.js';
export default async function bot3missing(client, interaction, data, reqEndpoint) {
    ...
    await interaction.guild.members
        ...
        .then(member => {
            ...
            if (member.voice.channel && member.voice.channel == interaction.member.voice.channel) addToQueue4 = true;
        })
        .catch(e => {
            bot4Availability = false;
        });
