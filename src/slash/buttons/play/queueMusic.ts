...
export default {
    name: 'queueMusic',
    run: async (client: Client, interaction: ButtonInteractionExtend<'cached'>) => {
        ...
        try {
            ...
            // const player = client.music.players.get(interaction.guild!.id)
            const { title, requester, id } = player.queue.current!
                    ...
                    embeds: [
                        new EmbedBuilder()
                            ...
                            .setDescription(
                                ...
                                }\n[${title}](https://www.music.youtube.com/watch?v=${player.queue.current.id}) [<@${
                            ...
                            .setAuthor({
                                name: `${interaction.language.QUEUE[6]} ${player.queue.current?.author} ${interaction.language.QUEUE[7]}`,
            ...
            embed.setDescription(
                `🎧 ${interaction.language.QUEUE[3]}\n [${title}](https://www.music.youtube.com/watch?v=${
                    ...
                    interaction.language.QUEUE[8]
                }__:\n${queuelist}`,
            )
            embed.setThumbnail(client.user.displayAvatarURL())
            embed.setAuthor({
                name: `${interaction.language.QUEUE[6]} ${interaction.user.username} ${
                    interaction.language.QUEUE[7]
