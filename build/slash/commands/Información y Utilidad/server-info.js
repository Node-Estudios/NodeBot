...
export default class serverinfo extends Command {
    ...
    async run(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            value: `<:pepeblink:967941236029788160> ${translate(keys.REGULAR)}: ${regular.size}\n<a:DJPeepo:969757766744944700> ${translate(keys.ANIMATED)}: ${animated.size}`,
            inline: true,
        }, {
            ...
            name: `<:plus:893553167709655091> ${translate(keys.CHANNELS)} [${interaction.guild.channels.cache.size}]`,
            value: `<:List_Bottom_Large:970441521637769287> ${translate(keys.CATEGORIES)}: ${category.size}\n<:textchannelblurple:893490117451333632> ${translate(keys.TEXT)}: ${text.size}\n<:blurple_voicechannel:970441881144156190> ${translate(keys.VOICE)}: ${voice.size}`,
            inline: true,
        }, {
