            ...
            return await interaction
                ...
                embeds: [
                    new EmbedBuilder()
                        ...
                        .setFields({ name: translate(keys.API), value: `${results[0].ping}ms`, inline: true }, { name: translate(keys.ping.internal), value: time + 'ms' }, { name: translate(keys.ping.global), value: `${ping}ms`, inline: true })
